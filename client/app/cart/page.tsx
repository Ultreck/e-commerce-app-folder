  ...
  return (
    <div className="px-16 py-10">
      ...
      <div className="text my-20">
        <EmptyPageComponent caption="There is no any items in your cart" text="All items added to your cart would be displayed here, You can click on add to cart button to proceed" className=""/>
      </div>
      }
    </div>
  );
