      ...
      >
        <DropdownMenuTrigger className="outline-none">
          ...
          className="text cursor-pointer rounded-full flex items-center border">
            ...
            >
              <div
               className="absolute inset-0 w-full h-full bg-gradient-to-r rounded from-amber-900 via-amber-700 to-amber-400 translate-x-full transition-transform duration-500 group-hover:translate-x-1"></div>
              <div 
              className="relative font-bold flex w-44">
                <Avatar>
                  <AvatarImage
                ...
                {!session?  <Skeleton className="h-full bg-golden w-full" /> : (
